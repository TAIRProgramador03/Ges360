...
<style>
    ...
    .cbo-registrar .cbo-form-cliente{
        width: 78%;
        right: 7px;
    }

    .form-cliente .cbo-form-cliente{
        width: 61%;
    }
    ...
    @media screen and (max-width: 800px){
        ...
        .cbo-registrar .cbo-form-cliente, .form-cliente .cbo-form-cliente, .cbo-registrar label, .form-cliente label, .resumen-form-contrato {
            width: 90%;
        }
                        ...
                        <tbody id="contratos-tbody" class="table-detalle">
                            <tr>
                                ...
                                <td>
                                    ...
                                    <!--<input type="text" name="modelo[]" value="" title="Modelo del vehiculo">--></td>
                                <td>
